...
export (Mesh) var rifle_model
export (Mesh) var pistol_model
export (Mesh) var knife_model

export (PackedScene) var impact
export (PackedScene) var shell
export (PackedScene) var magazine

export (AudioStreamSample) var rifle_shoot_sound
export (AudioStreamSample) var pistol_shoot_sound
export (AudioStreamSample) var reload_sound
export (AudioStreamSample) var empty_sound
